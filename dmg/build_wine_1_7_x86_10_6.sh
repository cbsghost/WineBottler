...
#export WINE_VERSION=1.7.38
export WINE_VERSION=1.7.52
#export WINE_VERSION=1.6.2
...
export LIBMPG123_VERSION=1.19.0 && prepare mpg123 $LIBMPG123_VERSION "http://www.mpg123.de/download/mpg123-$LIBMPG123_VERSION.tar.bz2" '--silent --enable-shared --disable-static --prefix='$BUILDDIRECTORY'/usr --with-cpu=generic_fpu'
...
export LCMS_VERSION=2.6 && prepare lcms2 $LCMS_VERSION "http://freefr.dl.sourceforge.net/project/lcms/lcms/"$LCMS_VERSION"/lcms2-"$LCMS_VERSION".tar.gz" '--silent --enable-shared --prefix='$BUILDDIRECTORY'/usr'
...
#tiff is not building with this! export LIBJPEG_VERSION=9a && prepare jpeg $LIBJPEG_VERSION "http://www.ijg.org/files/jpegsrc.v"$LIBJPEG_VERSION".tar.gz" '--silent --enable-shared --disable-static --prefix='$BUILDDIRECTORY'/usr'
...
export LIBPNG_VERSION=1.6.10 && prepare libpng $LIBPNG_VERSION "http://heanet.dl.sourceforge.net/project/libpng/libpng16/"$LIBPNG_VERSION"/libpng-"$LIBPNG_VERSION".tar.gz" '--silent --enable-shared --disable-static --prefix='$BUILDDIRECTORY'/usr'
...
export FREETYPE_VERSION=2.5.3 && prepare freetype $FREETYPE_VERSION "http://mirrors.zerg.biz/nongnu/freetype/freetype-"$FREETYPE_VERSION".tar.gz" '--silent --enable-shared --disable-static --prefix='$BUILDDIRECTORY'/usr'
...
#export FONTCONFIG_VERSION=2.11.1 && prepare fontconfig $FONTCONFIG_VERSION "http://www.fontconfig.org/release/fontconfig-"$FONTCONFIG_VERSION".tar.gz" '--silent --enable-shared --disable-static --prefix='$BUILDDIRECTORY'/usr --with-add-fonts=/usr/X11/lib/X11/fonts --with-add-fonts=/Library/Fonts --with-add-fonts=/Network/Library/Fonts --with-add-fonts=$BUILDDIRECTORY/share/fonts'
...
#wine 1.7.50
export GECKO_VERSION=2.40

#wine 1.5.37
#export GECKO_VERSION=2.36

#wine 1.6.2
#export GECKO_VERSION=2.21
echo "\ngecko"
logtext "    check availabiliy"
